...
TASK_TR = {
    ...
    "channel": "kanal yayını", "twap": "TWAP radarı (arşiv)", "twaplive": "canlı TWAP radarı",
    "sim": "liq simülasyonu",
}
...
def _gap_txt(sec) -> str:
    sec = float(sec or 0)
    return f"{sec / 60:.0f} dk" if sec >= 90 else f"{sec:.0f} sn"


def _twap_side(side) -> str:
