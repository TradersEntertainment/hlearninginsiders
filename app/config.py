...
EDITABLE_FIELDS: dict[str, dict] = {
    ...
    "census_hot_rpm": {"type": "int", "label": "Sayım: sıcak şerit hızı (istek/dk)",
                       "group": "Tarama & performans",
                       "desc": "Az önce işlem yapan adreslerin defteri (sıcak şerit) NORMAL şeritten, bu hızla çekilir (vars. 120/dk; clearinghouseState ağırlık 2) — düşük şerit 429'la duraklı olsa bile fill → defter dakikalar içinde. Kapsamayı asıl yükselten şerit budur. Toplu tarama düşük şeritte census_rpm ile kalır"},
...
class Config:
    def __init__(self) -> None:
        ...
        self.census_hot_rpm = int(os.getenv("CENSUS_HOT_RPM", "120"))
