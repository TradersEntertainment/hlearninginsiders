...
async def lifespan(app: FastAPI):
    ...
    from .radar.twapfollow import loop as twapfollow_loop
    _spawn("twapfollow", lambda: twapfollow_loop(cfg, collector, notifier), notifier)
    ...
    _spawn("sim", lambda: sim_loop(cfg, client, notifier), notifier)
